...
var regions = require('./../const/regions.json');
...
var departments = require('./../const/departments.json');
...
var categories = require('./../const/categories.json');
...
var subcategories = require('./../const/subcategories.json');
...
var getSubCategoriesExtras = (currentCategoryId, searchExtras) => {
...
var getLocation = (region, department) => {
    var location = {};
...
var parseNbResult = function (results) {
