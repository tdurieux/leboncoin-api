...
var parseNbPages = function ($) {
    const nbPagesRegex = /[\?&]o=([0-9]+)/g;
    const paginationLink = $('#last').attr('href');
    var regexResult = nbPagesRegex.exec(paginationLink);
    var result = 1;
    if (regexResult !== null && regexResult.length === 2) {
        result = parseInt(regexResult[1]);
    }
    return result;
};
...
module.exports.parseNbPages = parseNbPages;
