...
Item.prototype.__defineGetter__('bike', function() {
    return new Bike(this);
});

Bike.prototype.__defineGetter__('cubic_capacity', function() {
    var attr1 = this.ad.details.attributes.find(attr => attr.key == 'cubic_capacity');
    var v = attr1 ? attr1.value : '';
    return v;
});

Bike.prototype.__defineGetter__('mileage', function() {
    var attr1 = this.ad.details.attributes.find(attr => attr.key == 'mileage');
    var v = attr1 ? attr1.value : '';
    return v;
});

Bike.prototype.__defineGetter__('regdate', function() {
    var attr1 = this.ad.details.attributes.find(attr => attr.key == 'regdate');
    var v = attr1 ? attr1.value : '';
    return v;
});
