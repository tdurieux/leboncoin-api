...
Object.defineProperty(Bike.prototype, 'cubic_capacity', { get : function() {
    var attr1 = this.ad.details.attributes.find(attr => attr.key == 'cubic_capacity');
    var v = attr1 ? attr1.value : '';
    return v;
}});

Object.defineProperty(Bike.prototype, 'mileage', { get : function() {
    var attr1 = this.ad.details.attributes.find(attr => attr.key == 'mileage');
    var v = attr1 ? attr1.value : '';
    return v;
}});

Object.defineProperty(Bike.prototype, 'regdate', { get : function() {
